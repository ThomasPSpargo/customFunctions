...
#Contains custom functions for obtaining test statistics and degrees of freedom in pairwise t-test:
  #`pairwise.t.test.with.t.and.df` extends the logic of stats::pairwise.t.test
  #`pairwise.table.t` adapts stats::pairwise.table

#Currently, the function invokes repeated calls to stats::t.test
  #These are performed in order to obtain p.value, t.value (statistic), and degrees of freedom (parameter))
  #Could be streamlined by reusing the values from a single call
